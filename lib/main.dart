...
// A função main() e a porta de entrada do aplicativo
void main() {
  // coloca o aplicativo Flutter para funcionarç.
  runApp(const MeuApp());
}

// Significa que e classe está herdando as caracteristicas de um StatelessWidget
...
class _MediaEscolarPageState extends State<MediaEscolarPage> {
  ...
  String nomeAluno = '';
  String situacao = ''; // aprovado, recuperação e reprovado
  double media = 0;
  ...
  void calcularMedia(){
    ...
    if(nome.isEmpty || nota1 == null || nota2 == null || nota3 == null){
        mostrarMensagem("Preecha todos os campos corretamente");
        return;
    }
